...
:::image type="content" source="media/get-started-with-columnstore-for-real-time-operational-analytics/real-time-operational-analytics-overview.png" alt-text="Diagram of an OLTP and real-time operational analytics workload interaction.":::  
...
1. For each table, drop all B-tree indexes that are primarily designed to speed up existing analytics on your OLTP workload. Replace them with a single columnstore index.  This can improve the overall performance of your OLTP workload since there will be fewer indexes to maintain.  
...
-   [Business case for real-time operational analytics](https://www.microsoft.com/sql-server/blog/2015/12/09/real-time-operational-analytics-using-in-memory-technology)  
...
## Videos
 ...
 The Data Exposed video series into more details on some of the capabilities and considerations.

- [Part 1: How Azure SQL Enables Real-time Operational Analytics (HTAP)](/shows/data-exposed/How-Azure-SQL-Enables-Real-time-Operational-Analytics-HTAP-Part-1)
- [Part 2: Optimize existing databases and applications with operational analytics](/shows/data-exposed/optimize-existing-databases-and-applications-with-operational-analytics-in-azure-sql-part-2)
- [Part 3: How to create operational analytics with Window Functions](/shows/data-exposed/how-to-create-operational-analytics-with-window-functions-in-azure-sql-part-3).
...
### Example A: Access hot data from B-tree index, warm data from columnstore index
 ...
 :::image type="content" source="media/get-started-with-columnstore-for-real-time-operational-analytics/de-columnstore-warmhotdata.png" alt-text="Diagram showing combined indexes for warm and hot data.":::  
...
```  
 ...
 :::image type="content" source="media/get-started-with-columnstore-for-real-time-operational-analytics/query-plan-columnstore.png" alt-text="Screenshot from SQL Server Management studio of a query plan using a columnstore index scan." lightbox="media/get-started-with-columnstore-for-real-time-operational-analytics/query-plan-columnstore.png":::  
  
 For more information, see [Blog: Filtered nonclustered columnstore index](/archive/blogs/sqlserverstorageengine/real-time-operational-analytics-filtered-nonclustered-columnstore-index-ncci).
...
```  
 ...
 For more information, see  [Blog: Compression delay](/archive/blogs/sqlserverstorageengine/real-time-operational-analytics-compression-delay-option-for-nonclustered-columnstore-index-ncci).  
...
For advance users, we recommend running the following query and collect % of deleted rows over the last seven days.  
